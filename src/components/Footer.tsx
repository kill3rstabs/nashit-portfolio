...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-primary py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {['home', 'about', 'skills', 'experience', 'projects', 'contact'].map((item) => (
                <li key={item}>
                  <Link
                    ...
                    smooth={true}
                    duration={800}
                    className="text-gray-600 dark:text-text-secondary hover:text-secondary dark:hover:text-secondary transition-colors duration-300 cursor-pointer capitalize"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-text-secondary">
              <li>
                <a 
                  href="mailto:nashitnoorali78@gmail.com"
                  className="hover:text-secondary dark:hover:text-secondary transition-colors duration-300"
                >
            ...
            <div className="mt-4 flex space-x-4">
              <a
                ...
                className="text-gray-600 dark:text-text-secondary hover:text-secondary dark:hover:text-secondary transition-colors duration-300"
                aria-label="LinkedIn"
              >
